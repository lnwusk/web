...
export default function Login({ onSwitch }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{color: '#ffffff', fontSize: '2.5rem', fontWeight: '800', marginBottom: '0.5rem', textAlign: 'center', letterSpacing: '-0.025em', textShadow: '0 2px 16px rgba(0,0,0,0.5)', filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))'}}>登录</h2>
